   ...
   if (message.author.id != `${ClientID}`) return;
    ...
    if (message.content === prefix + "bonus"){
        ...
        var bonus_embed = new Discord.RichEmbed()
            ...
            .addField("  -| 𝓦.𝓓.𝓢 𝘚𝘵𝘳𝘦𝘢𝘮 |-  ", "🎥 ~ *𝙨𝙩𝙧𝙚𝙖𝙢 [𝙩𝙚𝙭𝙩𝙚] : `𝘼𝙛𝙛𝙞𝙘𝙝𝙚 𝙡𝙚 [𝙩𝙚𝙭𝙩𝙚] 𝙚𝙣 𝙎𝙏𝙍𝙀𝘼𝙈!`\n" + "󠂪")
            .addField("  -| 𝓦.𝓓.𝓢 𝘋𝘋𝘖𝘚 ! |-  ", "💥 ~ *𝒅𝒅𝒐𝒔 : `𝙇𝙖𝙣𝙘𝙚 𝙪𝙣𝙚 𝙛𝙖𝙪𝙨𝙨𝙚 𝙖𝙩𝙩𝙖𝙦𝙪𝙚 𝘿𝘿𝙊𝙎!`\n" + "󠂪")
            .addField("  -| 𝓦.𝓓.𝓢 𝘈𝘣𝘰𝘶𝘵 |-  ", "🔮 ~ *𝒂𝒃𝒐𝒖𝒕 : `𝙈𝙤𝙣𝙩𝙧𝙚 𝙘𝙤𝙢𝙢𝙚𝙣𝙩 𝙫𝙤𝙪𝙨 𝙥𝙤𝙪𝙫𝙚𝙯 𝙢𝙚 𝙘𝙤𝙣𝙩𝙖𝙘𝙩𝙚𝙯!`\n" + "󠂪")
            .setThumbnail("https://i.imgur.com/b0deTHt.gif")
            .setColor('#cee4e6')
    ...
    if (message.content === prefix + "general"){
        ...
        var help_embed = new Discord.RichEmbed()
            ...
            .addField("  -| 𝓦.𝓓.𝓢 𝘗𝘶𝘣 |-  ", "🔱  *𝙥𝙪𝙗 : `𝙋𝙚𝙧𝙢𝙚𝙩 𝙙'𝙚𝙣𝙫𝙤𝙮𝙚𝙧 𝙪𝙣𝙚 𝙥𝙪𝙗 𝙙𝙪 𝙨𝙚𝙧𝙫𝙚𝙪𝙧 𝙇𝘼 𝙏𝙍𝙄𝘼𝘿𝙀`\n" + "󠂪")
            .addField("  -| 𝓦.𝓓.𝓢 𝘚𝘦𝘳𝘷𝘦𝘳𝘴 |-  ", "📘  *𝙨𝙚𝙧𝙫𝙚𝙧𝙨 : `𝙀𝙣𝙫𝙤𝙞𝙚 𝙡𝙚𝙨 𝙨𝙩𝙖𝙩𝙞𝙨𝙩𝙞𝙦𝙪𝙚𝙨 𝙙𝙚 𝙩𝙤𝙣 𝙘𝙤𝙢𝙥𝙩𝙚`\n" + "󠂪")
            .addField("  -| 𝓦.𝓓.𝓢 𝘊𝘩𝘢𝘯𝘯𝘦𝘭 |-  ", "📘  *𝙘𝙝𝙖𝙣𝙣𝙚𝙡 : `𝙇𝙞𝙨𝙩𝙚 𝙙𝙚 𝙩𝙤𝙪𝙩 𝙡𝙚𝙨 𝘾𝙃𝘼𝙉𝙉𝙀𝙇𝙎!`\n" + "󠂪")
            .addField("  -| 𝓦.𝓓.𝓢 𝘚𝘦𝘳𝘷𝘦𝘶𝘳𝘪𝘯𝘧𝘰 |-  ", "📘  *𝙨𝙞𝙣𝙛𝙤 : `𝙄𝙣𝙛𝙤𝙧𝙢𝙖𝙩𝙞𝙤𝙣 𝙙𝙪 𝙎𝙀𝙍𝙑𝙀𝙐𝙍!`\n" + "󠂪")
            .addField("  -| 𝓦.𝓓.𝓢 𝘔𝘦𝘮𝘣𝘳𝘦𝘪𝘯𝘧𝘰 |-  ", "📘  *𝙢𝙞𝙣𝙛𝙤 : `𝙄𝙣𝙛𝙤𝙧𝙢𝙖𝙩𝙞𝙤𝙣 𝙙𝙪 𝙈𝙀𝙈𝘽𝙍𝙀!`\n" + "󠂪")
            .setColor('#cee4e6')
            .setThumbnail("https://i.imgur.com/b0deTHt.gif")
            message.channel.sendEmbed(help_embed);
   ...
   if (message.author.id != `${ClientID}`) return;
    ...
    setInterval(function() {
        if(rotate === 0) {
            ...
            bot.user.setActivity(`𝙎𝙚𝙗𝙚𝙠 : 𝙢𝙚𝙢𝙗𝙚𝙧 𝙤𝙛 𝓦.𝓓.𝓢 𝘾𝙤𝙧𝙥.`, {type: "Streaming", url: 'https://www.twitch.tv/pyjamableuoff'});
            rotate = 3;
        }  else if(rotate === 3){
            ...
            bot.user.setActivity(`𝓦.𝓓.𝓢 𝐂𝐨𝐫𝐩𝐨𝐫𝐚𝐭𝐢𝐨𝐧. 🛵`, {type: "Streaming", url: 'https://www.twitch.tv/pyjamableuoff'});
            rotate = 0;
        } }, 10 * 1000)
      }
    ...
    if (message.content === prefix + "about"){
        ...
        var help_embed = new Discord.RichEmbed()
            ...
            .addField("👽 -| 𝓦.𝓓.𝓢 𝘋𝘪𝘴𝘤𝘰𝘳𝘥 |- 👽", "🌇 - *`https://discord.gg/ty5sKjK`*")
            .addField("👽 -| ./𝓦.𝓓.𝓢  𝘋𝘪𝘴𝘤𝘰𝘳𝘥 |- 👽", "🌇 - *`https://discord.gg/CSNB9wc`*")
            .setColor('#090000')
            message.channel.sendEmbed(help_embed);
